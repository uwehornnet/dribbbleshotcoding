...
var _productSlider = require("./product-slider");
const app = new _app.App();
const prodcutSlider = new _productSlider.ProductSlider(document.querySelector(".container"));

},{"../styles/style.sass":"1vGWn","./product-slider":"2bEdi","./app":"XPJbz"}],"1vGWn":[function() {},{}],"2bEdi":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "ProductSlider", function () {
...
class ProductSlider {
  ...
  animateForward() {
    _gsapDefault.default.to(this.inner, {
      x: -this.bounds.width,
      duration: 1,
      ease: "Power3.easeInOut"
    });
    _gsapDefault.default.to(this.headline, {
      x: this.bounds.width - 240,
      duration: 1,
      ease: "Power3.easeInOut"
    });
    _gsapDefault.default.to(this.progress, {
      x: "100%",
      duration: 1,
      ease: "Power3.easeInOut"
    });
...
class App {
  ...
  init() {
    ...
    _gsapDefault.default.from(this.header, {
      y: -100,
      opacity: 0,
      duration: 1,
      delay: 0.75,
    ...
    _gsapDefault.default.from([this.sidebar.querySelector(".sidebar__body--inner h1"), this.sidebar.querySelector(".sidebar__body--inner p"), this.sidebar.querySelector(".sidebar__body--inner ul"), this.sidebar.querySelector(".sidebar__body--inner strong"), this.sidebar.querySelector(".sidebar__body--button")], {
      y: 100,
      opacity: 0,
      stagger: 0.1,
      duration: 1,
    ...
    _gsapDefault.default.from(this.sidebar.querySelector(".sidebar__breadcrumbs"), {
      x: -100,
      opacity: 0,
      duration: 1,
      delay: 0.75,
    ...
    _gsapDefault.default.from([...this.headline.map(line => line.querySelector("span"))], {
      y: 120,
      stagger: 0.1,
      duration: 1,
      delay: 0.25,
    ...
    _gsapDefault.default.from([...this.items], {
      y: 100,
      opacity: 0,
      duration: 1,
      delay: 0.8,
    ...
    _gsapDefault.default.from([this.pagination, this.controls], {
      y: 100,
      opacity: 0,
      duration: 1,
      delay: 0.6,
...
},{"gsap":"1iecp","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}]},["21c8X","3L8AI"], "3L8AI", "parcelRequirefea9")
